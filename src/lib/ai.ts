...
- '베니지민'은 실재하는 고구마 품종입니다. 소리나는 대로 적어 오타가 잦아요.
  오타 예) "배니지민"·"베나지민"·"베지니민"·"베니지믄"·"베니진민"·"베니지"·"베니 고구마" → 모두 "베니지민"으로 교정.
  '베니지민'(또는 위 오타)이 든 고구마는 name을 반드시 "베니지민 고구마"로 정리하세요.
  품목명이 "고구마"이고 부연설명(note)에 '베니지민'류가 있으면, name을 "베니지민 고구마"로 합치세요.`;
